...
We share a common interest in collaborating to successfully complete the task by role-playing.
    ...
    7. Knowing that our conversation will be read by a third party, please instruct me to summarize the final answer for TASK (the content can be in any form) before you say "CAMEL_TASK_DONE" (the termination of the conversation).
